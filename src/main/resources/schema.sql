create TABLE IF NOT EXISTS PUBLIC.AGE_RATE(
	AGE_RATE_ID INTEGER NOT NULL AUTO_INCREMENT,
	AGE_RATE CHARACTER VARYING(100) NOT NULL,
	CONSTRAINT AGE_RATE_PK PRIMARY KEY (AGE_RATE_ID)
);
...
create TABLE IF NOT EXISTS PUBLIC.FILMS(
	...
	CONSTRAINT FILMS_FK FOREIGN KEY (AGE_RATE) REFERENCES PUBLIC.AGE_RATE(AGE_RATE_ID) ON delete RESTRICT ON update RESTRICT
);
...
create TABLE IF NOT EXISTS PUBLIC.LIKE_FILMS(
	USER_ID INTEGER NOT NULL,
	FILM_ID INTEGER NOT NULL,
	CONSTRAINT LIKE_FILMS_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(USER_ID) ON delete RESTRICT ON update RESTRICT,
	CONSTRAINT LIKE_FILMS_FK_1 FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(FILM_ID) ON delete RESTRICT ON update RESTRICT
);
...
CREATE INDEX IF NOT EXISTS FILMS_FK_INDEX_3 ON PUBLIC.FILMS (AGE_RATE);
